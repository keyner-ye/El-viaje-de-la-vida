// ==========================================================================
// SERVIDOR WEB ASÍNCRONO DE ALTO RENDIMIENTO (Node.js CommonJS)
...
// - Cabeceras CORS completas, tipos MIME modernos y streaming directo.
// ==========================================================================
...
const server = http.createServer((req, res) => {
  // Cabeceras CORS globales para compatibilidad total (Edge, Chrome, Celular)
